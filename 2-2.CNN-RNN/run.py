...
def train(data, params):
    ...
    # cnnencoder = CNN(**params).cuda(params["GPU"])
    ...
    for e in range(params["EPOCH"]):
        ...
        for i in range(0, len(data["train_x"]), params["BATCH_SIZE"]):
            ...
            # batch_y = Variable(torch.LongTensor(y_labels)).cuda(params["GPU"])
        ...
        print("epoch:", e + 1,"train_loss:", trian_loss, "/ dev_acc:", dev_acc, "/ test_acc:", test_acc)
...
def main():
    ...
    parser.add_argument("--hidden dim", default=300, type=int, help="the dimension of encoder and decoder")
