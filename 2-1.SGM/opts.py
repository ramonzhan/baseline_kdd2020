def model_opts(parser):
    ...
    parser.add_argument('-seed', default=214, type=int, help="random seed")
    ...
    parser.add_argument('-module', default='seq2seq', type=str, help="module selection")
    ...
    parser.add_argument('-refF', default='', type=str, help="reference file")
    ...
    parser.add_argument('-label_dict_file', default='/home/rleating/kdd2020/dataset/sgm/it_1/label_sorted.json', type=str)
