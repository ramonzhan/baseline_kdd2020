...
class Data():
    ...
    def load_data_separated(self):
        ...
        path = self.path
        dataset_name = self.dataset_name
        x_train = np.load(path + dataset_name + '/train_x.npy')
        y_train = np.load(path + dataset_name + '/train_y.npy')
        x_test = np.load(path + dataset_name + '/test_x.npy')
        y_test = np.load(path + dataset_name + '/test_y.npy')
